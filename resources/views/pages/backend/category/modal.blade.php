      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form-create" name="form-tambah-edit">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <label class="form-label" for="address">Nama</label>
...
<div class="modal fade" id="edit-modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal-edit">Edit Kategori</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <form id="form-edit" name="form-tambah-edit">
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="name" id="edit_name" placeholder="Nama..">
